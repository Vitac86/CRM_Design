...
`static-uikit/assets/css/crm-static.bundle.css` уже сгенерирован как вспомогательный readable-бандл; файл нельзя редактировать вручную, только пересобирать из `crm-static.css` и импортируемых модульных CSS.
