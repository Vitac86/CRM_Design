  ...
  return (
    <section className="w-full rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-3 text-slate-600">
        Заглушка раздела: <span className="font-medium text-slate-800">{location.pathname}</span>
      </p>
      <div className="mt-6 rounded-lg border border-brand-light bg-brand-light/40 p-4 text-sm text-slate-700">
        ...
        <pre className="mt-2 overflow-auto rounded bg-white p-3 text-xs text-slate-600">
